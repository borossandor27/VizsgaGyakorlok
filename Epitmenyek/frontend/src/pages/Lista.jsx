    ...
    <>
      ...
      <header className="al-fejlec">
        <div className="container-xl">
          ...
          <p className="al-alcim">
            Az adatbázisban nyilvántartott összes épített örökség
          </p>
        </div>
      </header>
        ...
        <div className="container-xl">
          ...
          {toroltvaSiker && (
            <div className="alert alert-success d-flex align-items-center gap-2 mb-3">
              ...
              <span>
                A(z) <strong>{toroltvaSiker}. azonosítójú</strong> építmény
                törölve.
              </span>
            </div>
          )}
          ...
          {torlesJelolt && (
            <div className="torles-confirm">
              <span className="torles-confirm-szoveg">
                ...
                Biztosan törli a(z) <strong>„{torlesJelolt.nev}"</strong>{" "}
                rekordot? Ez nem visszavonható.
              </span>
              <button
              ...
              <button
                className="torles-nem"
                onClick={() => setTorlesJelolt(null)}
              >
                Mégse
              </button>
            </div>
          ...
          {hiba && !betolt && (
            <div className="hiba-sav">
              ...
              {hiba}
              <br />
              <button className="btn btn-outline-secondary mt-3" onClick={tolt}>
                Újrapróbálás
              </button>
            </div>
          )}
                ...
                <table className="table tabla-epitmeny mb-0">
                  <thead>
                    <tr>
                      ...
                      <th className="text-center" style={{ width: "7rem" }}>
                        Műveletek
                      </th>
                    </tr>
                  </thead>
                  <tbody>
                    {adatok.map((e) => (
                      <tr key={e.azon} className="tabla-sor">
                        ...
                        <td>
                          <TipusBadge tipus={e.tipus} />
                        </td>
                        <td>
                          <i className="bi bi-geo-alt-fill tabla-geo me-1" />
                          <a
                            href={`https://www.google.com/maps/search/${encodeURIComponent(e.nev + ", " + e.telepules_nev)}`}
                            target="_blank"
      ...
      {kivalasztott && (
        <div
          ...
          onClick={(e) => {
            if (e.target === e.currentTarget) setKivalasztott(null);
          }}
        >
